...
const Projects = () => {
    ...
    return (
        <div className='py-20'>
            ...
            <div>
                <h1 className="text-3xl md:text-5xl font-bold text-center py-5 text-[#36e8f8]" data-aos="fade-up ">Complete <span className='text-black'>Projects</span></h1>

                <p data-aos="zoom-in" className="text-base text-black font-bold text-center  px-4 xl:px-48 lg:px-36 md:px-20 pt-8 pb-14">We have successfully completed 200+ projects . This project include corrporate meeting , expo , seminars , team building , product launches and award ceremony related. We will also should be provide 100% authentic service for improve your project success. </p>
